...
# Across-front
function uu_func(i, j, k, grid, advection, u)
    return advective_momentum_flux_Uu(i, j, k, grid, advection, u, u) / Axᶜᶜᶜ(i, j, k, grid)
end

function uv_func(i, j, k, grid, advection, u, v)
    return  advective_momentum_flux_Uv(i, j, k, grid, advection, u, v) / Axᶠᶠᶜ(i, j, k, grid)
end

function uw_func(i, j, k, grid, advection, u, w)
    return advective_momentum_flux_Uw(i, j, k, grid, advection, u, w) / Axᶠᶜᶠ(i, j, k, grid)
end

function ub_func(i, j, k, grid, advection, u, b)
    return advective_tracer_flux_x(i, j, k, grid, advection, u, b) / Axᶠᶜᶜ(i, j, k, grid)
end
